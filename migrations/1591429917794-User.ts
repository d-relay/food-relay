...
export class User1591429917794 implements MigrationInterface {
    name = 'User1591429917794'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" BIGSERIAL NOT NULL, "client_id" character varying(255) NOT NULL, "login" character varying(255) NOT NULL, "accessToken" character varying(255) NOT NULL, "refreshToken" character varying(255) NOT NULL, "sign_in_count" integer NOT NULL DEFAULT 0, "current_sign_in_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "last_sign_in_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "userId" bigint, CONSTRAINT "UQ_fed09e6f9c08a5031ba1e3e9701" UNIQUE ("client_id"), CONSTRAINT "UQ_a62473490b3e4578fd683235c5e" UNIQUE ("login"), CONSTRAINT "REL_d72ea127f30e21753c9e229891" UNIQUE ("userId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
